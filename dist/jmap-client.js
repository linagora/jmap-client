...
},{"./client/Client":2,"./models/Account":3,"./models/AccountCapabilities":4,"./models/Attachment":5,"./models/AuthAccess":6,"./models/AuthContinuation":7,"./models/Capabilities":8,"./models/CreateMessageAck":9,"./models/EMailer":10,"./models/MailCapabilities":11,"./models/Mailbox":12,"./models/MailboxRole":13,"./models/Message":14,"./models/MessageList":15,"./models/Model":16,"./models/OutboundMessage":17,"./models/SetResponse":18,"./models/Thread":19,"./models/VacationResponse":20,"./promises/ES6PromiseProvider":21,"./promises/PromiseProvider":22,"./promises/QPromiseProvider":23,"./transport/JQueryTransport":24,"./transport/RequestTransport":25,"./transport/Transport":26,"./utils/Constants":27,"./utils/JSONBuilder":28,"./utils/Utils":29}],2:[function(require,module,exports){
'use strict';
  ...
  _createClass(Client, [{
    ...
    value: function createMailbox(name, parentId) {
      ...
      return this.setMailboxes({
        ...
        return new _modelsMailboxJs2['default'](_this4, created.id, created.name || name, created);
      });
    }
...
},{"../utils/Utils.js":29,"./AccountCapabilities":4,"./Capabilities":8,"./MailCapabilities":11,"./Model.js":16}],4:[function(require,module,exports){
'use strict';
...
var Attachment = (function (_Model) {
  ...
  _createClass(Attachment, [{
    ...
    value: function getSignedDownloadUrl() {
      _utilsUtilsJs2['default'].assertRequiredParameterIsPresent(this.url, 'url');

      return this._jmap.transport.post(this.url, this._jmap._defaultHeaders(), null, true).then(_utilsUtilsJs2['default'].appendQueryParameter.bind(null, this.url, 'access_token'));
    }
...
},{"../utils/JSONBuilder.js":28,"../utils/Utils.js":29,"./Model.js":16}],6:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":29}],8:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":29,"./Model.js":16}],10:[function(require,module,exports){
'use strict';
...
},{"./Capabilities":8}],12:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":29,"./MailboxRole.js":13,"./Model.js":16}],13:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":29,"./Attachment.js":5,"./EMailer.js":10,"./Model.js":16}],15:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":29,"./Model.js":16}],16:[function(require,module,exports){
'use strict';
...
},{"../utils/JSONBuilder.js":28,"../utils/Utils.js":29,"./Attachment.js":5,"./Model.js":16}],18:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":29,"./Model.js":16}],19:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":29,"./Model.js":16}],20:[function(require,module,exports){
'use strict';
...
},{"../utils/JSONBuilder.js":28,"../utils/Utils.js":29,"./Model.js":16}],21:[function(require,module,exports){
'use strict';
...
},{"./PromiseProvider.js":22}],22:[function(require,module,exports){
'use strict';
...
},{"./PromiseProvider.js":22,"q":"q"}],24:[function(require,module,exports){
'use strict';
...
},{"./Transport.js":26}],25:[function(require,module,exports){
'use strict';
...
},{"./Transport.js":26,"request":"request"}],26:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":29}],29:[function(require,module,exports){
'use strict';
