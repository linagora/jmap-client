...
},{"./client/Client":2,"./models/Account":3,"./models/AccountCapabilities":4,"./models/Attachment":5,"./models/AuthAccess":6,"./models/AuthContinuation":7,"./models/Capabilities":8,"./models/CreateMailboxAck":9,"./models/CreateMessageAck":10,"./models/EMailer":11,"./models/MailCapabilities":12,"./models/Mailbox":13,"./models/MailboxRole":14,"./models/MailboxesSet":15,"./models/Message":16,"./models/MessageList":17,"./models/MessagesSet":18,"./models/Model":19,"./models/OutboundMessage":20,"./models/Thread":21,"./promises/ES6PromiseProvider":22,"./promises/PromiseProvider":23,"./promises/QPromiseProvider":24,"./transport/JQueryTransport":25,"./transport/RequestTransport":26,"./transport/Transport":27,"./utils/Constants":28,"./utils/JSONBuilder":29,"./utils/Utils":30}],2:[function(require,module,exports){
'use strict';
...
var _modelsMailboxesSetJs = require('./../models/MailboxesSet.js');

var _modelsMailboxesSetJs2 = _interopRequireDefault(_modelsMailboxesSetJs);
  ...
  _createClass(Client, [{
    ...
    value: function authenticate(username, deviceName, continuationCallback) {
      ...
      return this.transport.post(this.authenticationUrl, this._defaultNonAuthenticatedHeaders(), {
        ...
        return _this._authenticateResponse(data, continuationCallback);
      });
    }
    ...
    value: function _authenticateResponse(data, continuationCallback) {
      ...
      if (data.continuationToken && data.accessToken === undefined) {
        ...
        return continuationCallback(authContinuation).then(function (continueData) {
          ...
          return _this2.transport.post(_this2.authenticationUrl, _this2._defaultNonAuthenticatedHeaders(), param);
        }).then(function (resp) {
          return _this2._authenticateResponse(resp, continuationCallback);
        });
    ...
    value: function createMailbox(name, parentId) {
      ...
      return this.setMailboxes({
        ...
        return new _modelsCreateMailboxAckJs2['default'](_this3, mailboxesSet.created[clientId]);
      });
    }
    ...
    value: function destroyMailbox(id) {
      ...
      return this.setMailboxes({ destroy: [id] }).then(function (mailboxesSet) {
    ...
    value: function destroyMessage(id) {
      return this.destroyMessages(id && [id]).then(function (messagesSet) {
    ...
    value: function _createMessage(message, role) {
      ...
      return this.getMailboxWithRole(role).then(function (mailbox) {
        ...
        return new _modelsCreateMessageAckJs2['default'](_this4, response.created[clientId]);
      });
    }
  }, {
    ...
    value: function _jmapRequest(command, options) {
      ...
      return this.transport.post(this.apiUrl, this._defaultHeaders(), [[command, options || {}, '#0']]).then(_utilsUtilsJs2['default'].assertValidJMAPResponse.bind(null, command)).then(function (data) {
        return data.map(_this5._handleResponse.bind(_this5));
    ...
    value: function _handleMailboxesSetResponse(response) {
      return _modelsMailboxesSetJs2['default'].fromJSONObject(this, response[1]);
    }
  }, {
...
},{"../utils/Constants.js":28,"./../models/Account.js":3,"./../models/AuthAccess.js":6,"./../models/AuthContinuation.js":7,"./../models/CreateMailboxAck.js":9,"./../models/CreateMessageAck.js":10,"./../models/Mailbox.js":13,"./../models/MailboxRole.js":14,"./../models/MailboxesSet.js":15,"./../models/Message.js":16,"./../models/MessageList.js":17,"./../models/MessagesSet.js":18,"./../models/OutboundMessage.js":20,"./../models/Thread.js":21,"./../promises/ES6PromiseProvider.js":22,"./../utils/Utils.js":30}],3:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":30,"./AccountCapabilities":4,"./Capabilities":8,"./MailCapabilities":12,"./Model.js":19}],4:[function(require,module,exports){
'use strict';
...
},{"../utils/JSONBuilder.js":29,"../utils/Utils.js":30,"./Model.js":19}],6:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":30,"./Model.js":19}],10:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":30,"./Model.js":19}],11:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":30,"./MailboxRole.js":14,"./Model.js":19}],14:[function(require,module,exports){
'use strict';
...
var MailboxesSet = (function (_Model) {
  _inherits(MailboxesSet, _Model);
  ...
  function MailboxesSet(jmap, opts) {
    _classCallCheck(this, MailboxesSet);

    _get(Object.getPrototypeOf(MailboxesSet.prototype), 'constructor', this).call(this, jmap);
  ...
  _createClass(MailboxesSet, null, [{
    key: 'fromJSONObject',
    value: function fromJSONObject(jmap, object) {
      _utilsUtilsJs2['default'].assertRequiredParameterIsPresent(object, 'object');
...
exports['default'] = MailboxesSet;
module.exports = exports['default'];

},{"../utils/Utils.js":30,"./Model.js":19}],16:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":30,"./Attachment.js":5,"./EMailer.js":11,"./Model.js":19}],17:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":30,"./Model.js":19}],18:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":30,"./Model.js":19}],19:[function(require,module,exports){
'use strict';
...
},{"../utils/JSONBuilder.js":29,"../utils/Utils.js":30,"./Attachment.js":5,"./Model.js":19}],21:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":30,"./Model.js":19}],22:[function(require,module,exports){
'use strict';
