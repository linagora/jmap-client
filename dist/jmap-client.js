...
},{"./client/Client":2,"./models/Account":3,"./models/AccountCapabilities":4,"./models/Attachment":5,"./models/AuthAccess":6,"./models/AuthContinuation":7,"./models/Capabilities":8,"./models/CreateMailboxAck":9,"./models/CreateMessageAck":10,"./models/EMailer":11,"./models/MailCapabilities":12,"./models/Mailbox":13,"./models/MailboxRole":14,"./models/Message":15,"./models/MessageList":16,"./models/Model":17,"./models/OutboundMessage":18,"./models/SetResponse":19,"./models/Thread":20,"./models/VacationResponse":21,"./promises/ES6PromiseProvider":22,"./promises/PromiseProvider":23,"./promises/QPromiseProvider":24,"./transport/JQueryTransport":25,"./transport/RequestTransport":26,"./transport/Transport":27,"./utils/Constants":28,"./utils/JSONBuilder":29,"./utils/Utils":30}],2:[function(require,module,exports){
'use strict';
...
var _modelsSetResponseJs = require('./../models/SetResponse.js');

var _modelsSetResponseJs2 = _interopRequireDefault(_modelsSetResponseJs);
...
var _modelsCreateMailboxAckJs = require('./../models/CreateMailboxAck.js');

var _modelsCreateMailboxAckJs2 = _interopRequireDefault(_modelsCreateMailboxAckJs);
...
var _modelsVacationResponse = require('./../models/VacationResponse');

var _modelsVacationResponse2 = _interopRequireDefault(_modelsVacationResponse);
...
var Client = (function () {
  ...
  function Client(transport, promiseProvider) {
    ...
    this.promiseProvider = promiseProvider || new _promisesES6PromiseProviderJs2['default']();
  ...
  _createClass(Client, [{
    ...
    value: function withAuthAccess(access) {
      ...
      _utilsUtilsJs2['default'].assertRequiredParameterHasType(access, 'access', _modelsAuthAccessJs2['default']);
    ...
    value: function createMailbox(name, parentId) {
      ...
      return this.setMailboxes({
        ...
        return new _modelsCreateMailboxAckJs2['default'](_this4, response.created[clientId]);
      });
    }
    ...
    value: function destroyMailbox(id) {
      ...
      return this.setMailboxes({ destroy: [id] }).then(function (response) {
    ...
    value: function updateMessage(id, options) {
      _utilsUtilsJs2['default'].assertRequiredParameterIsPresent(id, 'id');
      _utilsUtilsJs2['default'].assertRequiredParameterIsObject(options, 'options');
    ...
    value: function destroyMessages(ids) {
      _utilsUtilsJs2['default'].assertRequiredParameterIsArrayWithMinimumLength(ids, 'ids', 1);
    ...
    value: function saveAsDraft(message) {
      return this._createMessage(message, _modelsMailboxRoleJs2['default'].DRAFTS);
    }
    ...
    value: function send(message) {
      return this._createMessage(message, _modelsMailboxRoleJs2['default'].OUTBOX);
    }
    ...
    value: function setVacationResponse(vacationResponse, options) {
      _utilsUtilsJs2['default'].assertRequiredParameterHasType(vacationResponse, 'vacationResponse', _modelsVacationResponse2['default']);

      return this._jmapRequest('setVacationResponse', {
        accountId: options && options.accountId || null,
        update: _defineProperty({}, _modelsVacationResponse2['default'].ID, vacationResponse.toJSONObject())
      }).then(function (response) {
        if (response.updated.indexOf(_modelsVacationResponse2['default'].ID) < 0) {
          throw new Error('Failed to set vacation response. Error: ' + (response.notUpdated[_modelsVacationResponse2['default'].ID] || 'none'));
        }
      });
    }
  }, {
    key: '_createMessage',
    value: function _createMessage(message, role) {
      var _this5 = this;
      ...
      return this.getMailboxWithRole(role).then(function (mailbox) {
        message.mailboxIds = [mailbox.id];
        message.isDraft = _modelsMailboxRoleJs2['default'].DRAFTS.value === role.value ? true : null;
        ...
        return new _modelsCreateMessageAckJs2['default'](_this5, response.created[clientId]);
      });
    }
  }, {
    ...
    value: function _jmapRequest(command, options) {
      ...
      return this.transport.post(this.apiUrl, this._defaultHeaders(), [[command, options || {}, '#0']]).then(_utilsUtilsJs2['default'].assertValidJMAPResponse.bind(null, command)).then(function (data) {
        return data.map(_this6._handleResponse.bind(_this6));
    ...
    value: function _handleListResponse(response, Model, filter) {
      return _utilsUtilsJs2['default']._jsonArrayToModelList(this, Model, response[1].list, filter);
    }
  }, {
    key: '_handleSetResponse',
    value: function _handleSetResponse(response) {
      return _modelsSetResponseJs2['default'].fromJSONObject(this, response[1]);
    }
  }, {
    ...
    value: function _handleMessagesResponse(response) {
      return this._handleListResponse(response, _modelsMessageJs2['default'], function (message) {
        try {
          return _utilsUtilsJs2['default'].assertRequiredParameterIsArrayWithMinimumLength(message.mailboxIds, 'mailboxIds', 1);
        } catch (err) {
          return false;
        }
      });
    ...
    value: function _handleVacationResponseResponse(response) {
      return this._handleListResponse(response, _modelsVacationResponse2['default']);
    }
  }, {
...
},{"../utils/Constants.js":28,"./../models/Account.js":3,"./../models/AuthAccess.js":6,"./../models/AuthContinuation.js":7,"./../models/CreateMailboxAck.js":9,"./../models/CreateMessageAck.js":10,"./../models/Mailbox.js":13,"./../models/MailboxRole.js":14,"./../models/Message.js":15,"./../models/MessageList.js":16,"./../models/OutboundMessage.js":18,"./../models/SetResponse.js":19,"./../models/Thread.js":20,"./../models/VacationResponse":21,"./../promises/ES6PromiseProvider.js":22,"./../utils/Utils.js":30}],3:[function(require,module,exports){
'use strict';
...
var Account = (function (_Model) {
  ...
  function Account(jmap, id, opts) {
    ...
    this.capabilities = _utilsUtilsJs2['default']._nullOrNewInstance(opts.capabilities, _AccountCapabilities2['default']);
    this.mail = _utilsUtilsJs2['default']._nullOrNewInstance(opts.mail, _MailCapabilities2['default']);
    this.contacts = _utilsUtilsJs2['default']._nullOrNewInstance(opts.contacts, _Capabilities2['default']);
    this.calendars = _utilsUtilsJs2['default']._nullOrNewInstance(opts.calendars, _Capabilities2['default']);
  }
...
},{"../utils/Utils.js":30,"./AccountCapabilities":4,"./Capabilities":8,"./MailCapabilities":12,"./Model.js":17}],4:[function(require,module,exports){
'use strict';
...
},{"../utils/JSONBuilder.js":29,"../utils/Utils.js":30,"./Model.js":17}],6:[function(require,module,exports){
'use strict';
...
function AuthAccess(payload) {
  ...
  ['username', 'accessToken', 'apiUrl', 'eventSourceUrl', 'uploadUrl', 'downloadUrl'].forEach(function (property) {
    _utilsUtilsJs2['default'].assertRequiredParameterIsPresent(payload[property], property);
  });
...
},{"../utils/Utils.js":30}],8:[function(require,module,exports){
'use strict';
...
var CreateMailboxAck = (function (_Model) {
  _inherits(CreateMailboxAck, _Model);
  ...
  function CreateMailboxAck(jmap, response) {
    _classCallCheck(this, CreateMailboxAck);

    _get(Object.getPrototypeOf(CreateMailboxAck.prototype), 'constructor', this).call(this, jmap);
    _utilsUtilsJs2['default'].assertRequiredParameterIsObject(response, 'response');
    _utilsUtilsJs2['default'].assertRequiredParameterIsPresent(response.id, 'response.id');

    this.id = response.id;
    this.mustBeOnlyMailbox = response.mustBeOnlyMailbox || false;
  }

  return CreateMailboxAck;
})(_ModelJs2['default']);

exports['default'] = CreateMailboxAck;
module.exports = exports['default'];

},{"../utils/Utils.js":30,"./Model.js":17}],10:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":30,"./Model.js":17}],11:[function(require,module,exports){
'use strict';
...
var MailCapabilities = (function (_Capabilities) {
  ...
  function MailCapabilities(opts) {
    ...
    _get(Object.getPrototypeOf(MailCapabilities.prototype), 'constructor', this).call(this, opts);
...
},{"./Capabilities":8}],13:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":30,"./MailboxRole.js":14,"./Model.js":17}],14:[function(require,module,exports){
'use strict';
...
var Message = (function (_Model) {
  ...
  function Message(jmap, id, threadId, mailboxIds, opts) {
    ...
    this.from = _utilsUtilsJs2['default'].nthElementOrDefault(opts.from, 0, new _EMailerJs2['default'](opts.from));
    this.to = opts.to || [];
    this.cc = opts.cc || [];
    this.bcc = opts.bcc || [];
  ...
  _createClass(Message, [{
    ...
    value: function setIsFlagged(isFlagged) {
      _utilsUtilsJs2['default'].assertRequiredParameterHasType(isFlagged, 'isFlagged', 'boolean');
    ...
    value: function setIsUnread(isUnread) {
      _utilsUtilsJs2['default'].assertRequiredParameterHasType(isUnread, 'isUnread', 'boolean');
    ...
    value: function setIsAnswered(isAnswered) {
      _utilsUtilsJs2['default'].assertRequiredParameterHasType(isAnswered, 'isAnswered', 'boolean');
...
},{"../utils/Utils.js":30,"./Attachment.js":5,"./EMailer.js":11,"./Model.js":17}],16:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":30,"./Model.js":17}],17:[function(require,module,exports){
'use strict';
...
},{"../utils/JSONBuilder.js":29,"../utils/Utils.js":30,"./Attachment.js":5,"./Model.js":17}],19:[function(require,module,exports){
'use strict';
...
var SetResponse = (function (_Model) {
  ...
  function SetResponse(jmap, opts) {
    ...
    _get(Object.getPrototypeOf(SetResponse.prototype), 'constructor', this).call(this, jmap);
...
},{"../utils/Utils.js":30,"./Model.js":17}],20:[function(require,module,exports){
'use strict';
...
var Thread = (function (_Model) {
  ...
  _createClass(Thread, [{
    ...
    value: function _flagAllMessages(flag, state) {
      _utilsUtilsJs2['default'].assertRequiredParameterHasType(state, 'state', 'boolean');
...
},{"../utils/Utils.js":30,"./Model.js":17}],21:[function(require,module,exports){
'use strict';
...
var VacationResponse = (function (_Model) {
  ...
  function VacationResponse(jmap, opts) {
    ...
    _get(Object.getPrototypeOf(VacationResponse.prototype), 'constructor', this).call(this, jmap);
  ...
  _createClass(VacationResponse, [{
    key: 'toJSONObject',
    value: function toJSONObject() {
      return new _utilsJSONBuilderJs2['default']().append('id', this.id).append('isEnabled', this.isEnabled).appendDateIfDefined('fromDate', this.fromDate).appendDateIfDefined('toDate', this.toDate).appendIfDefined('subject', this.subject).appendIfDefined('textBody', this.textBody).appendIfDefined('htmlBody', this.htmlBody).build();
    }
...
},{"../utils/JSONBuilder.js":29,"../utils/Utils.js":30,"./Model.js":17}],22:[function(require,module,exports){
'use strict';
...
},{"./PromiseProvider.js":23}],23:[function(require,module,exports){
'use strict';
...
},{"./PromiseProvider.js":23,"q":"q"}],25:[function(require,module,exports){
'use strict';
...
},{"./Transport.js":27}],26:[function(require,module,exports){
'use strict';
...
},{"./Transport.js":27,"request":"request"}],27:[function(require,module,exports){
'use strict';
...
var JSONBuilder = (function () {
  ...
  _createClass(JSONBuilder, [{
    ...
    value: function appendDateIfDefined(name, date) {
      if (_utilsUtilsJs2['default'].isDefined(date)) {
        _utilsUtilsJs2['default'].assertRequiredParameterHasType(date, 'date', Date);
...
},{"../utils/Utils.js":30}],30:[function(require,module,exports){
'use strict';
