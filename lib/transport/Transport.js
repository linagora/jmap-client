...
export default class Transport {
   ...
   * * A HTTP POST request is made on _url_ with the given _headers_ and _data_ (i.e.: payload)
   * * A {@link Promise} is returned (_this.promiseProvider_ will be available to create Promise instances)
