...
export default class Client {
   ...
   *
   * @param filterRules {FilterRule[]|Object[]} The {@link FilterRule} instance to set
  ...
  setFilter(filterRules, options) {
    let filterRulesAsJson = filterRules.map(rule => rule instanceof FilterRule ? rule.toJSONObject() : rule);
