...
export default class Client {
   ...
   * This token will then be used as the _Authorization_ header, as per {@link http://jmap.io/spec.html#authenticating-http-requests}.<br />
   * <br />
   * The token will be exposed as the _authToken_ property afterwards.
   *
   ...
   * <br />
   * The URL will be exposed as the _apiUrl_ property afterwards.
   *
