...
export default class Utils {
  ...
  /**
   * Asserts that the given _parameter_ is present (read: truthy).<br />
  ...
  /**
   * Asserts that the given _data_ is a valid JMAP response.<br />
   ...
   * * _data_ is defined and is an array
   * * _data_ has one or more elements, and all elements are arrays
   * * _data[0][0]_ is either
   *   * the expected response string (computed with the help of the _request_ parameter)
   *   * an unknown response
   * * _data[0][1]_ exists
   *
   ...
   * If _undefined_, _null_, the _empty string_ or something else that a string is given, the argument is returned as-is.
   *
